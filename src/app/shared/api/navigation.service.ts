...
export interface INavigationServiceInterface {
    /*
    reset(): void;
    complete(): void;
    next(brands: NavigationLink[]): void;
   */
...
export class NavigationService implements INavigationServiceInterface {

    private navigationMegamenu: NavigationLink[] = [
    ...
    private navigationPimalion: NavigationLink[] = [
        ...
        {label: 'Comparer', url: '/shop/compare'        }
  ...
  public NavigationChangedSub$ =  new BehaviorSubject<NavigationLink[]>(this.getNavigation());
...
/*
  ...
  public next(navigation: NavigationLink[]) {
    if (navigation) {
     ...
     getNavigation(): NavigationLink[] {
        ...
        switch(getModeSource()) {
            ...
            case 'demo.sourcing.pm':
                ...
                return this.navigationPimalion.concat(this.navigation);
                // return this.navigationPimalion;

            default: // 'fake-server'; 'json':

                return this.navigation.concat(this.navigationMegamenu);
        }
    }
}
