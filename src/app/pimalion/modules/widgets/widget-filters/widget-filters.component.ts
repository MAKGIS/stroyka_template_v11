...
} from 'src/app/shared/interfaces/filter';
...
export class WidgetFiltersComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.pageCategory.list$.pipe(
            ...
            console.log('-br-- WidgetFiltersComponent.ngOnInit() this.filters -> %O', this.filters);
    ...
    makeFiltersForm(filters: Filter[]): FormGroup {
        ...
        console.log('--f-- WidgetFiltersComponent.makeFiltersForm() filters -> %O', filters);
