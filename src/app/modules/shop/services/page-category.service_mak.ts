...
export class PageCategoryService {
    ...
    // mak  ???
    public ListOptionsChangedSub$ =  new BehaviorSubject<ListOptions>(this.optionsState);
    public ListOptionsChanged$ = this.ListOptionsChangedSub$.asObservable();
    // public ListOptionsChangedValue = this.ListOptionsChangedSub$.getValue();
    ...
    get filters(): Filter[] {
        console.log("--s-->>PageCategoryService.filters() listState -> %o", this.listState);
    ...
    get filterValues(): SerializedFilterValues {
      console.log("--s-->>PageCategoryService.filterValues() listState -> %o", this.listState);
    ...
    setOptions(options: ListOptions, emitEvent: boolean = true): void {
        ...
        /*
        diff.filtersBrand = options.filtersBrand;

        console.log('-s->>> PageCategoryService.setOptions() 2 options ->%o', options);
        console.log('-s->>> PageCategoryService.setOptions() 2 diff ->%o', diff);
        console.log('-s->>> PageCategoryService.setOptions() 2 optionsState ->%o', this.optionsState);

        // mak ???
        this.ListOptionsChangedSub$.next(this.optionsState);
   */
    ...
    updateOptions(options: ListOptions, emitEvent: boolean = true): void {
        console.log('-s->>> PageCategoryService.updateOptions() options ->%o', options);
        console.log('-s->>> PageCategoryService.updateOptions() optionsState ->%o', this.optionsState);
