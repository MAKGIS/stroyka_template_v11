...
import { getModeSource } from './brands';
...
export function getCategoriesDef(): CategoryDef[] {

    var categoriesDef: CategoryDef[] = [];
...
/*
export function setShopCategoriesDef(categoriesDefNew: CategoryDef[]  ) {
...
export const [shopCategoriesTree, shopCategoriesList]: [Category[], Category[]] = walkTree('shop', getCategoriesDef());
